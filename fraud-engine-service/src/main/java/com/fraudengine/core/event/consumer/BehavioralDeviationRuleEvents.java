...
import com.fraudengine.core.rule.strategy.BehavioralDeviationRule;
...
@KafkaListener(id = "fraud-behavioral-deviation-rule", groupId = "fraud-behavioral-deviation-rule",
        topics = "${environment}-transaction-created")
public class BehavioralDeviationRuleEvents {

    private final RuleHandler handler;
    private final BehavioralDeviationRule rule;
    ...
    public void ruleExecute(
        ...
        log.trace(
                "Received transaction {} for behavioral deviation check (topic: {}, partition: {}, offset: {})",
